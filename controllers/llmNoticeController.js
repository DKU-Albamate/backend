...
exports.generateLLMNotice = async (req, res) => {
  ...
  try {
    ...
    'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-lite:generateContent?key=' + process.env.GEMINI_API_KEY,
    {
        ...
        parts: [{
            text: `
            당신은 사장님이 입력한 키워드를 바탕으로, 알바생들에게 전달할 **안내사항 공지의 제목과 본문**을 정중하고 가독성 좋게 작성하는 역할입니다.
            오늘 날짜는 ${today}입니다.
            ...
            또한, 작성된 제목과 본문에서 **핵심 키워드 1~5개**를 뽑아서 \`tags\` 항목으로 함께 제공해주세요.
            - 해시태그나 설명 없이, 단어만 담긴 문자열 배열로 주세요.
            - 키워드는 주제나 핵심 내용을 대표해야 합니다.
            입력된 내용:
            ${input}
